...
#i:not(:checked)~div .observation{display:none}
...
.objects{padding:20px 28px;border-top:1px solid #667265;display:flex;gap:14px;align-items:center;flex-wrap:wrap}.objects p{margin:0}.objects small{display:block}
...
@media(max-width:480px){.scene-heading{padding:22px 18px}.scene-heading h1{font-size:34px}.scene-controls{padding:12px;gap:6px}.scene-controls button{padding:8px 10px}.objects,.nearby{padding:18px}.map-help{padding:12px 18px}}
`;
