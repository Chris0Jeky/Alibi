...
(function (G) {
  ...
  const paths = {
    ...
    notebook:
      '<rect x="5" y="3" width="16" height="18" rx="2"/><path d="M3 7h4m-4 5h4m-4 5h4m4-10h6m-6 5h6m-6 5h4"/>',
    comfort:
    ...
    bridges:
      '<circle cx="5" cy="6" r="3"/><circle cx="19" cy="18" r="3"/><path d="M8 5h11v10M5 9v10h11"/>',
  };
  function icon(name) {
  ...
  function engraving(room) {
    const art = {
      study:
        '<path d="M24 68h112M33 68v20m94-20v20M89 68V34m-19 0h38L96 14H82ZM41 64V36h15v28m-19-8h22"/><path d="M72 82h32M20 94h122"/>',
      library:
        '<path d="M24 18h112v72H24ZM24 53h112M44 24v23m7-23v23m12-23v23m6-23v23m18-23v23m7-23v23m12-23 8 22M39 61v22m8-22v22m15-22v22m8-22v22m18-22v22m7-22 8 22m9-22v22"/>',
