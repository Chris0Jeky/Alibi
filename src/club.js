  ...
  function record(id, s) {
    ...
    const r = state.runs[id],
      key =
        id +
        ':' +
        (id === 'borough' ? r.seed : id === 'archive' ? r.level : r.mode) +
        ':' +
