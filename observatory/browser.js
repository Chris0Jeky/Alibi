...
const config = {"id":"alibi","project":{"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms","puzzle.started","puzzle.completed","puzzle.failed","hint.requested"],"routes":["home","puzzle","castle","quiet-wing","other"],"releases":["unattributed","0.11.3","0.11.4","0.11.5"],"measurements":["duration.ms"]},"origin":"https://alibi-after-hours-preview.commit-atlas.workers.dev","endpoint":"https://pulseboard-observatory.commit-atlas.workers.dev/v1/collect/alibi","scopePath":"/","release":"unattributed","route":"home","clicks":[],"contextGlobal":"ALIBI_OBSERVATORY_CONTEXT","publicFlag":{"global":"ALIBI_CONFIG","key":"standalone","expected":false}};
