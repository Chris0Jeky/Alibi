...
const config = {"id":"alibi","project":{"label":"Alibi","origin":"https://alibi-after-hours-preview.commit-atlas.workers.dev","probe":{"url":"https://alibi-after-hours-preview.commit-atlas.workers.dev/","marker":"Alibi"},"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms","puzzle.started","puzzle.completed","hint.requested"],"routes":["home","puzzle","castle","quiet-wing","other"],"releases":["unattributed"],"measurements":["duration.ms"],"dailyLimit":1000},"origin":"https://alibi-after-hours-preview.commit-atlas.workers.dev","endpoint":"","scopePath":"/","release":"unattributed","route":"home","clicks":[],"publicFlag":{"global":"ALIBI_CONFIG","key":"standalone","expected":false}};
