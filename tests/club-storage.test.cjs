    ...
    JSON.stringify(
      {
        ...
        scope:
          'Separate Node VM sessions sharing a localStorage fixture. Tests the exact fallback key, rotation, pinning, fallback and sequential conflicts, plus a source-contract guard that restore cancels the keeper before persist. Not real IndexedDB transactions, Worker interleaving or browser durability.',
        checks,
      },
      null,
      2,
