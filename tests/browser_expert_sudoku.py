...
def main():
    ...
    with sync_playwright() as pw:
        ...
        for width in (390, 1440):
            ...
            expect(page.locator(".filter-meta")).to_contain_text("6 puzzles")
            expect(page.locator(".puzzle-card")).to_have_count(6)
            ...
            checks.append(f"Expert filter shows six provisional puzzles at {width}px")
