...
def main():
    ...
    with sync_playwright() as pw:
        ...
        for width in (390, 1440):
            ...
            # 3 Expert + 3 After Hours + 12 Vault Expert studies (Vault listing entries carry difficulty).
            expect(page.locator(".filter-meta")).to_contain_text("18 puzzles")
            expect(page.locator(".puzzle-card")).to_have_count(18)
            ...
            checks.append(f"Expert filter shows 18 provisional puzzles at {width}px")
