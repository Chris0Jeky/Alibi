...
puzzle = json.loads((ROOT/'content/extra/nonogram-large.json').read_text())['puzzles'][0]
with sync_playwright() as pw:
    ...
    for width in (390, 1440):
        ...
        assert page.locator('.nono-cell').first.bounding_box()['width'] >= 44
        ...
        print(f'PASS 15x15 nonogram controls, auto-cross, undo and offline at {width}px',flush=True)
        context.close()
    browser.close()
