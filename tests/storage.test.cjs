    ...
    JSON.stringify(
      {
        ...
        assertions,
        scope:
          'Node VM: exact cabinet fallback keys, session/local fallback, sequential revision conflict, export, corruption preservation, single-read corruption message, null-key iteration, destructive-restore refusal and newer-database refusal. Not IndexedDB transaction or reload testing.',
      },
      null,
      2,
    ),
