"""Boot the derived Android payload under its stable local HTTPS origin."""
import mimetypes
...
with sync_playwright() as pw:
    ...
    check(page.evaluate("()=>globalThis.ALIBI_BUILD_TARGET") == 'android', 'Android target marker loads first')
    check(
