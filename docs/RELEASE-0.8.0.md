...
Source candidate in [PR #26](https://github.com/Chris0Jeky/Alibi/pull/26), integrated with merged
PR #27. This checkpoint records local acceptance; deployment confirmation follows the reviewed
merge. Primary and fallback identities remain those in [DEPLOYMENT.md](DEPLOYMENT.md).
