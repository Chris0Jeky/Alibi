...
0.11.0. The in-app "What's new" entry now also names the Block Cabinet accessibility correction
from PR #105. Remaining follow-ups (route and release hooks, control coverage in the browser
